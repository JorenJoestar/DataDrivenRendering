...
layout (location = 0) COMPAT_ATTRIBUTE vec4 VertexCoord;
layout (location = 1) COMPAT_ATTRIBUTE vec4 COLOR;
layout (location = 2) COMPAT_ATTRIBUTE vec4 TexCoord;
//layout (location = 0) COMPAT_VARYING vec4 COL0;
...
void main()
{
    vec2 pos = Warp(TEX0.xy*(TextureSize.xy/InputSize.xy));//*(TextureSize.xy/InputSize.xy))*(InputSize.xy/TextureSize.xy);
