...
namespace hfx {
    ...
    typedef hydra::graphics::ResourceLayoutCreation::Binding    ResourceBinding;
    ...
    void                                shader_effect_init( ShaderEffectFile& out_file, const char* full_filename );
    ...
    struct CodeGenerator {
        ...
        TypeDefinitionAlias*        name_to_type    = nullptr;
