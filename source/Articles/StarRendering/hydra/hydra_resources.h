...
// Revision history //////////////////////
//
//      0.02 (2020/04/07): + Updated library to newest gfx + hfx libraries. + Switched to Simdjson usage.
...
struct ResourceFactory {
    ...
    struct LoadContext {
        ...
        hydra::graphics::RenderFrame* render_pipeline;
    ...
    virtual void                    reload( Resource* old_resource, Resource* new_resource, StringBuffer& temp_string_buffer, hydra::graphics::Device& gfx_device, hydra::graphics::RenderFrame* render_pipeline ) {}
...
struct ShaderFactory : public ResourceFactory {
    ...
    void                            reload( Resource* old_resource, Resource* new_resource, StringBuffer& temp_string_buffer, hydra::graphics::Device& gfx_device, hydra::graphics::RenderFrame* render_pipeline ) override;
};
...
struct ResourceManager {
    ...
    Resource*                       load_resource( ResourceType::Enum type, const char* filename, hydra::graphics::Device& gfx_device, hydra::graphics::RenderFrame* render_pipeline );
    void                            init_resource( Resource** resource, char* memory, hydra::graphics::Device& gfx_device, hydra::graphics::RenderFrame* render_pipeline );

    void                            reload_resources( ResourceType::Enum type, hydra::graphics::Device& gfx_device, hydra::graphics::RenderFrame* render_pipeline );
    void                            reload_resource( Resource* resource, hydra::graphics::Device& gfx_device, hydra::graphics::RenderFrame* render_pipeline );
