...
// Revision history //////////////////////
//
//      0.10 (2021/08/19): + Added service static instance.
//      0.09 (2021/07/01): + Added enum names.
//      0.08 (2021/06/30): + Added find methods for action and action maps.
//      0.07 (2021/06/24): + Complete rework of internal action/binding working. Flattened the array. Moved to handles.
//      0.06 (2021/06/24): + Added debug ImGui rendering.
//      0.05 (2021/06/18): + Fixed has focus update handling by putting it inside callback.
...
struct InputService : public Service {
    ...
    hy_declare_service( InputService );
